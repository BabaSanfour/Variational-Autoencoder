...
<img src="https://latex.codecogs.com/svg.image?\bg{white}&space;ELBO&space;=&space;\sum\limits_{i=1}^{N}&space;\left(&space;\mathbb{E}_{z&space;\sim&space;q_\phi(z|x_i)}&space;\left[&space;\log&space;p_\theta(x_i&space;|&space;z)&space;\right]&space;&plus;&space;\mathbb{KL}\left[&space;q_\phi(z|x_i)&space;\,&space;||&space;\,&space;\mathcal{N}(0,&space;I)&space;\right]&space;\right)">
