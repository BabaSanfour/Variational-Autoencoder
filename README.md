...
<img src="https://render.githubusercontent.com/render/math?math=\text{ELBO}=\sum\limits_{i=1}^N\left(\mathbb{E}_{z\simq_\phi(z|x_i)}[\log p_\theta(x_i | z)]+\mathbb{KL}[q_\phi(z|x_i)||\mathcal{N}(0,I)]\right)">
